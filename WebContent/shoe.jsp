...
<div class="container">
	...
	<form action="manager.do" method="post">	
			<div> 	
				<span>商品id</span>
				<input type="text" id="goodid" name="goodid" value="<%=id %>">
				<%
						String errorMsg=(String)request.getAttribute("error_id");
						if(errorMsg==null){
							errorMsg="\t";
						}
				%> 
			...
			<div> 
				<span >商品名称</span>
				<input type="text" id="goodname" name="goodname" value="<%=name %>">
				<%
						String errorMsg1=(String)request.getAttribute("error_name");
						if(errorMsg1==null){
							errorMsg1="\t";
						}
				%> 
			...
			<div> 
				<span >商品大小</span>
				<input type="text" id="goodsize" name="goodsize" value="<%=size %>">
				<%
						String errorMsg2=(String)request.getAttribute("error_size");
						if(errorMsg2==null){
							errorMsg2="\t";
						}
				%> 
			...
			<div> 
				<span >商品款式</span>
				<input type="text" id="gooddesign" name="gooddesign" value="<%=design %>">
				<%
						String errorMsg3=(String)request.getAttribute("error_design");
						if(errorMsg3==null){
							errorMsg3="\t";
						}
				%> 
			...
			<div> 
				<span >商品价格</span>
				<input type="text" id="goodprice" name="goodprice" value="<%=price %>">
				<%
						String errorMsg4=(String)request.getAttribute("error_price");
						if(errorMsg4==null){
							errorMsg4="\t";
						}
				%> 
